...
def send_joint_position_actionlib():
    # rosnode の初期化
    # rospy.init_node('send_joint_position') # toward_recognizedColor_move_arm.pyを走らせるときにはコメントアウトする必要がある
    ...
    goal.trajectory.joint_names = ['arm_joint1', 'arm_joint2', 'arm_joint3', 'arm_joint4', 'arm_joint5', 'arm_joint6']
    for i in range(5):
